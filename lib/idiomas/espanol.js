...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE 𝚁𝚄𝙱𝚈 BOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR 𝚁𝚄𝙱𝚈 BOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝑹𝒖𝒃𝒚 𝑩𝒐𝒕 - 𝑾𝒉𝒂𝒕𝒔𝒂𝒑𝒑'} 
...
const eGataCoins = () => { return '🐧𝑹𝒖𝒃𝒚Coins' }
...
//_antiviewonce.js
const smsAntiView = () => { return `*Jaja 𝑹𝒖𝒃𝒚 Bot Lo Ve Todo*`} 
